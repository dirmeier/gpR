...
`lvgpp` is a Bayesian machine learning package using latent variable Gaussian processes. In general supervised machine learning can be divided in classification, where we describe data using discrete labels, and regression, where the labels are continuous. 
